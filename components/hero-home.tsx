      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <div className="pb-12 pt-16 md:pb-20 md:pt-24">
          ...
          <div className="grid gap-8 lg:grid-cols-2 lg:gap-8 items-center">
            ...
            {/* Content side */}
            <div className="pb-8 text-center lg:text-left lg:pb-16 order-2 lg:order-1">
              {/* Social Links */}
              <div
              ...
              {/* Main Heading */}
              <h1
                className="mb-4 border-y text-4xl font-bold [border-image:linear-gradient(to_right,transparent,--theme(--color-slate-300/.8),transparent)1] sm:text-5xl md:text-6xl"
                data-aos="zoom-y-out"
                data-aos-delay={150}
              >
                Muhammad Abubakar
